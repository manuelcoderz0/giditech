...
<header class="hidden">
    <div class="h-10.5 bg-black items-center topb hidden md:flex">
            ...
            <div class="flex items-center justify-between h-full relative">
                ...
                <div class="ml-3.75 flex items-center">
                    <div class="flex items-center gap-1">
                        <a href="#" aria-label="X" class="flex items-center justify-center size-6.5 p-1 rounded-full bg-[#ffffff1f] border">
                            <svg class="size-3.5 text-white stroke-current stroke-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <a href="#" aria-label="LinkedIn" class="flex items-center justify-center size-6.5 p-1 rounded-full bg-[#ffffff1f] border">
                            <svg class="size-3.5 text-white stroke-current stroke-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <a href="#" aria-label="Tiktok" class="flex items-center justify-center size-6.5 p-1 rounded-full bg-[#ffffff1f] border">
                            <svg class="size-3.5 text-white stroke-current stroke-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <div class="h-17.5 bg-white dark:bg-black border-b border-[#efefef] w-full mx-auto max-w-340 relative px-6 sm:px-6 md:px-8 lg:px-20 flex items-center">
        <div class="w-full flex items-center justify-between">
            <div>
                <a href="{ route('home') }" use:inertia class="">
            ...
            <div>
                <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                    ...
                    <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--adaptive:adaptive] [--is-collapse:true] md:[--is-collapse:false] ">
                        <button id="hs-header-base-dropdown" type="button" class="hs-dropdown-toggle w-full p-2 flex items-center text-sm font-semibold text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-hidden focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                        ...
                        <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 relative w-full md:w-52 hidden z-10 top-full ps-7 md:ps-0 md:bg-white md:rounded-lg md:shadow-md before:absolute before:-top-4 before:start-0 before:w-full before:h-5 md:after:hidden after:absolute after:top-1 after:start-4.5 after:w-0.5 after:h-[calc(100%-4px)] after:bg-gray-100 dark:bg-black" role="menu" aria-orientation="vertical" aria-labelledby="hs-header-base-dropdown">
                            <div class="py-1 md:px-1 space-y-0.5">
                                {#each categories as category}
                                    <a href="" class="p-2 md:px-3 flex items-center text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-white dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300">
                                        { category.name }
                                    </a>
                                {/each}
                            </div>
                    ...
                    <a class="p-2 flex items-center text-sm font-semibold text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-hidden focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="#">
            ...
            <div class="flex items-center gap-3.5">
                <button class="bg-[#900068] py-1 px-3 rounded-md">
                    <span class="text-white uppercase text-[12px]">Subscribe</span>
                </button>
                <a href="" aria-label="">
...
<header class="z-999 relative">
    ...
    <div class="h-17.5 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white border-b border-gray-200 dark:bg-black dark:border-neutral-700 butb [&.butb]:md:border-b">
                    ...
                    <a class="p-2 flex items-center text-sm font-semibold bg-gray-100 dark:bg-[#FFFFFF14] border-b-2 border-[#900068] text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-hidden focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="#" aria-current="page">
                        ...
                        <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--adaptive:adaptive] [--is-collapse:true] md:[--is-collapse:false] ">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 relative w-full md:w-52 hidden z-10 top-full ps-7 md:ps-0 md:bg-white md:rounded-lg md:shadow-md before:absolute before:-top-4 before:start-0 before:w-full before:h-5 md:after:hidden after:absolute after:top-1 after:start-4.5 after:w-0.5 after:h-[calc(100%-4px)] after:bg-gray-100 dark:bg-transparent dark:md:bg-black dark:after:bg-neutral-700" role="menu" aria-orientation="vertical" aria-labelledby="hs-header-classic-dropdown">
                                <div class="py-1 md:px-1 space-y-0.5">
                                    {#each categories as category}
                                        <a class="py-1.5 px-2 flex items-center text-sm font-semibold text-gray-800 hover:text-gray-500 focus:outline-hidden focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500" href="#">
                                            { category.name }
                                        </a>
                                    {/each}
