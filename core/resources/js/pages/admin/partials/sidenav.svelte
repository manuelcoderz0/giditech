    ...
    <div class="relative z-11111 flex flex-col justify-between h-screen">
        ...
        <div class="overflow-y-auto flex-1">
            <ul class="flex flex-col">
                ...
                <li class="mt-2 mx-3">
                    <a href="{ route('admin.subscriber.index') }" use:inertia={{ prefetch: true }} use:active={'admin.subscriber.index'}  class="flex flex-wrap gap-2 items-center text-gray-300 px-2 py-2 rounded-md hover:bg-[#4634ff] transition-all duration-300 ease-out">
                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="currentColor" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round">
