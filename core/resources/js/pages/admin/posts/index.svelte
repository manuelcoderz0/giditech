                                        ...
                                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <div class="flex flex-wrap justify-end gap-2">
                                                <div class="flex gap-2">
                                                    <button command="show-modal" commandfor="edit" data-id="{post.id}" data-name="{post.name}" type="button" class="px-2 py-1 text-xs font-medium text-center inline-flex items-center text-white rounded focus:outline-none bg-blue-600 hover:bg-blue-700 focus:ring-blue-800 edit">
                                                    ...
                                                    {#if post.status}
                                                        <button command="show-modal" commandfor="confirm" data-question="Are you sure to disable this category? This action can be undone." data-action="{ route('admin.category.status', post.id) }" type="button" class="px-2 py-1 text-xs font-medium text-center inline-flex items-center text-white rounded focus:outline-none bg-red-600 hover:bg-red-700 focus:ring-red-800 confirm">
                                                    ...
                                                    {:else}
                                                        <button command="show-modal" commandfor="confirm" data-question="Are you sure to enable this category? This action can be undone." data-action="{ route('admin.category.status', post.id) }" type="button" class="px-2 py-1 text-xs font-medium text-center inline-flex items-center text-white rounded focus:outline-none bg-green-600 hover:bg-green-700 focus:ring-green-800 confirm">
                                                            <svg class="size-3 me-1 stroke-2 stroke-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
